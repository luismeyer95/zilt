(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.azil = {}));
})(this, (function (exports) { 'use strict';

    class AzilError extends Error {
    }
     ...
     */
    function once(value) {
        return new AzilIterator((function* () {
            yield value;
        })());
    }
    /**
    ...
    class AzilIterator {
        ...
        *[Symbol.iterator]() {
        ...
        skip(num) {
            if (num < 0)
                throw new AzilError("Invalid skip parameter");
            const previous = this.generator;
            return iter((function* () {
                let iter = previous();
                for (let i = 0; i < num; ++i) {
        ...
        take(num) {
            if (num < 0)
                throw new AzilError("Invalid take parameter");
            const previous = this.generator;
            return iter((function* () {
                for (const item of previous()) {
                    if (num === 0)
        ...
        reduce(func, initializer = null) {
            ...
            if (initializer === null && first.done) {
                throw new AzilError("Reduce of empty iterator with no initial value");
            }
        ...
        flatten(maxDepth) {
            if (maxDepth < 0 || maxDepth > 10)
                throw new AzilError("Invalid depth for flatten, allowed range is [0, 10]");
        ...
        windows(k) {
            if (k <= 0)
                throw new AzilError("Invalid window length");
            const previous = this.generator.bind(this);
            return iter((function* () {
                let window = [];
                let yielded = false;
        ...
        step(step) {
            if (step <= 0)
                throw new AzilError("Invalid step");
            const previous = this.generator.bind(this);
            return iter((function* () {
                let index = 0;
                for (const item of previous()) {
        ...
        stretch(count) {
            if (count < 0)
                throw new AzilError("Invalid stretch parameter");
            const previous = this.generator.bind(this);
            return iter((function* () {
                if (count === 0)
                    return;
