 ...
 *   .collect();
 */
export declare function iter<T>(input: Iterable<T>): AzilIterator<T>;
/**
 ...
 *   .collect();
 */
export declare function once<T>(value: T): AzilIterator<T>;
/**
 ...
 *   .collect();
 */
export declare function chain<T>(...iterables: Iterable<T>[]): AzilIterator<T>;
/**
 ...
 * range(-4).collect()      // [0, -1, -2, -3]
 */
export declare function range(start: number, end: number): AzilIterator<number>;
export declare function range(end: number): AzilIterator<number>;
export declare function range(): AzilIterator<number>;
declare class AzilIterator<T> {
    private generator;
     ...
     *   .collect();
     */
    map<F extends (val: T, index: number) => any>(func: F): AzilIterator<ReturnType<F>>;
    /**
     ...
     *   .collect();
     */
    filter(func: (val: T, index: number) => boolean): AzilIterator<T>;
    /**
     ...
     *   .collect();
     */
    skip(num: number): AzilIterator<T>;
    /**
     ...
     *   .collect();
     */
    take(num: number): AzilIterator<T>;
    /**
     ...
     *   .collect();
     */
    takeWhile(pred: (val: T, index: number) => boolean): this;
    /**
    ...
    accumulate<U>(f: (acc: U, element: T) => U, initializer: U): AzilIterator<U>;
    /**
     ...
     */
    rate(pred: (val: T) => boolean): number;
    /**
     ...
     *   .collect();
     */
    flatten<N extends number>(maxDepth: N): AzilIterator<RecursiveFlatten<N, T>>;
    /**
     ...
     *   .collect();
     */
    chunks(k: number): AzilIterator<T[]>;
    /**
     ...
     *   .collect();
     */
    windows(k: number): AzilIterator<T[]>;
    /**
     ...
     *   .collect();
     */
    step(step: number): AzilIterator<T>;
    /**
     ...
     *   .collect();
     */
    zip<I extends Iterable<any>[]>(...iterables: I): AzilIterator<[T, ...MapToIterType<I>]>;
    /**
     ...
     *   .collect();
     */
    flatMap<F extends (val: T, index: number) => any>(func: F): AzilIterator<import("./utils").Flatten<ReturnType<F>>>;
    /**
     ...
     *   .collect();
     */
    chain<I extends Iterable<any>[]>(...iterables: I): AzilIterator<T | TupleToUnion<MapToIterType<I>>>;
    /**
     ...
     *   .collect();
     */
    cycle(count?: number): AzilIterator<T>;
    /**
     ...
     *   .collect();
     */
    stretch(count: number): AzilIterator<T>;
    /**
     ...
     *   .collect();
     */
    uniqueBy(getKey: (element: T) => unknown): AzilIterator<T>;
    /**
     ...
     *   .consume();
     */
    inspect(func: (element: T) => unknown): AzilIterator<T>;
    /**
     ...
     *   .collect();
     */
    slice(start: number, end?: number): AzilIterator<T>;
    /**
